function validarVoto() {
  ...
  if(isCheck()){
    ...
    setTimeout('rehabilitarVotaciones()', 3000);
  }
  if(isLlenosPass(pass1.value)){
...
function rehabilitarVotaciones(){
  document.getElementById("mensaje").innerHTML = "";
  document.getElementById("cedula").style.border = "none";
