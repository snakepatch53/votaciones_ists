<body>
 <script src="personalizacion/paginas_candidato/js/controles.js"></script>
  <div class="col-md-13">
    <div class="box box-widget widget-user">
      ...
      <div class="widget-user-image">
        <img class="img-circle" src="personalizacion/fotos_candidatos/<?php echo $_SESSION['foto'] ?>" alt="User Avatar" style="transform:scale(2.4);margin-top:190px;height:90px;">
      </div>
      <div class="box-footer" style="margin-top: 100px;">
        <div class="row">
          ...
          <div class="col-sm-4 border-right">
            <div class="description-block">
              <h5 class="description-header"><?php echo $_SESSION['cargo_nombre'] ?></h5>
          ...
          <div class="col-sm-4">
            <div class="description-block">
              <h5 class="description-header"><?php echo '\''.$_SESSION['lista_letra'].'\' '.$_SESSION['lista_nombre'] ?></h5>
              <span class="description-text">LISTA</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="datos">
      <form action="personalizacion/paginas_candidato/php/guardar_cambios.php" method="post" enctype="multipart/form-data" id="form_datos">
        <input type="hidden" name="id_candidato" value="<?php echo $_SESSION['id_candidato'] ?>">
        <div class="fila_form">
          <label>NOMBRE: </label>
          <input type="text" name="nombre" placeholder="Nombre" required id="nombre" value="<?php echo $_SESSION['nombre'] ?>">
        </div>
        <div class="fila_form">
          <label>APELLIDO: </label>
          <input type="text" name="apellido" placeholder="Apellido" required id="apellido" value="<?php echo $_SESSION['apellido'] ?>">
        </div>
        <div class="fila_form">
          <label>FOTO: </label>
          <input type="file" accept="image/x-png" name="foto"  required>
        </div>
        <div class="fila_form">
          <label>CEDULA: </label>
          <input type="text" name="cedula" placeholder="Cedula" required id="cedula" value="<?php echo $_SESSION['cedula'] ?>">
        </div>
        <div class="fila_form">
