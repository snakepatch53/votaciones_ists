  ...
  <div class="wrapper">
            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                <li class="user-header">
                  ...
                  <br><b style="font-size:15px;color:white;"><?php echo $_SESSION['nombre'] ?></b>
                  <br><label style="font-size:12px;"><?php echo $_SESSION['curso'] ?></label>
    ...
    <div class="content-wrapper">
      <section class="content" style="padding:0;">
        <?php
        $path = "personalizacion/paginas_votantes/";
        if(isset($_GET['page'])){
          switch($_GET['page']){
